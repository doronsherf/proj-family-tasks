...
export class AddtComponent implements OnInit {
	...
	// Short way to build form items by using FormBuilder (not formControl+formGroup) 
	public newTask = this.frm_bldr.group({
	   ...
	   /* 	
	 // form building its items using(formGroup + formControl) 
	...
	public fam_membrs_build(){// function declaretion 
